...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('application/views/reportes/fpdf/logo.png', 10, 15, 40); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
      $this->SetFont('Arial', 'B', 19); //tipo fuente, negrita(B-I-U-BIU), tamañoTexto
      $this->Cell(50); // Movernos a la derecha
      $this->SetTextColor(0, 0, 0); //color
      //creamos una celda o fila
      $this->Cell(170, 15, utf8_decode('REPORTE GENERAL DE RESERVAS'), 0, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
     ...
     //$this->SetFillColor(0, 126, 20); //colorFondo
      ...
      $this->Cell(80, 10, utf8_decode('Cliente '), 1, 0, 'C', 1);
      $this->Cell(60, 10, utf8_decode('paquete '), 1, 0, 'C', 1);
      $this->Cell(50, 10, utf8_decode('Fecha de evento'), 1, 0, 'C', 1);
      $this->Cell(40, 10, utf8_decode('Recibo'), 1, 0, 'C', 1);
...
$pdf->Cell(50, 10, utf8_decode(""), 0, 0, 'C', 0);
$pdf->Cell(40, 10, utf8_decode("Total Bs: "), 1, 0, 'C', 0);
$pdf->Cell(30, 10, utf8_decode($total), 1, 1, 'C', 0); 




$pdf->Output('reporte_'.$hoy, 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
